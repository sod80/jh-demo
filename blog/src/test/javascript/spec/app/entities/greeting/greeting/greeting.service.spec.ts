...
describe('Service Tests', () => {
    describe('Greeting Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GreetingService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'greeting/api/greetings';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Greeting', () => {
                service.create(new Greeting(null)).subscribe(received => {
            ...
            it('should update a Greeting', () => {
                service.update(new Greeting(123)).subscribe(received => {
